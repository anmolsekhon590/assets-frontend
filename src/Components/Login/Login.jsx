...
export default function Login() {
    ...
    if (sessionStorage.getItem("jwtToken") !== null) {
        ...
        return (
            <div className="max-w-xl m-auto bg-white mt-10 rounded-md">
                <form className="shadow-md rounded-md p-8 text-2xl" onSubmit={handleSubmit(onSubmit)} >
                    <div className="mb-3">
                        <label htmlFor="username">Username: </label>
                        <input className="w-full border-2 p-2 rounded-md" type="text" name="username" {...register("username")} placeholder="Enter username here" />
                    </div>
                    <div className="mb-3">
                        <label htmlFor="password">Password: </label>
                        <input className="w-full border-2 p-2 rounded-md" type="password" {...register("password")} placeholder="Enter Password Here" />
                    </div>
